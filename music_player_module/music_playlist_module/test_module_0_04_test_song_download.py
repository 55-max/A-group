...
if __name__ == '__main__':
    ...
    # jazz songs
    user_select_3_songs = [['Erroll Garner', 'Misty'], ['セキトオ・シゲオ', '処女航海'], ['The Dave Brubeck Quartet','Take Five'] ]

    # J-pop songs
    user_select_3_songs = [['LiSA', '紅蓮華'], ['YOASOBI', '夜に駆ける'], ['米津玄師','Lemon'] ]

    # 80's J-pop
    user_select_3_songs = [['槇原敬之', 'どんなときも。'], ['槇原敬之', 'もう恋なんてしない'], ['槇原敬之','遠く遠く'] ]

    # Hiphop
    user_select_3_songs = [['ブルーノ・マーズスヌープ・ドッグウィズ・カリファ', 'Young, Wild & Free (feat. Bruno Mars)'], ['Lil Uzi Vert', 'That Way'], ['Lil Nas X, Jack Harlow','INDUSTRY BABY (feat. Jack Harlow)']]

    # ジブリ
    user_select_3_songs = [['久石譲', 'あの夏へ'], ['久石譲', '風の通り道'], ['久石譲','海の見える街'] ]

    # anime songs
    user_select_3_songs = [['Ado', 'ビンクスの酒'], ['T-Pistonz+KMC', 'つながリーヨ'], ['林原めぐみ','Over Soul'] ]

    # electro
    user_select_3_songs = [['Kyoto Black, Mihka!', 'Kodokushi'], ['takahiro(FKS)', 'I been stuck, just wanna break out'], ['Armin van Buuren','Blah Blah Blah'] ]
